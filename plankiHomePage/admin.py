...
@admin.register(Sashes)
class SashesAdmin(admin.ModelAdmin):
    fields = ['id', 'name', 'slug', 'description', 'image', 'get_image', 'stock', 'available', 'price', 'time_create']
    readonly_fields = ['id', 'time_create', 'get_image']
    list_display = ['id', 'name', 'get_image', 'stock', 'available', 'price', 'time_create']
    list_display_links = ['id', 'name', 'get_image']
    list_editable = ['stock', 'available', 'price']
    search_fields = ['name']
    prepopulated_fields = {"slug": ("name",)}
...
@admin.register(Jettons)
class JettonsAdmin(admin.ModelAdmin):
    fields = ['id', 'name', 'slug', 'description', 'image', 'get_image', 'stock', 'available', 'price', 'time_create']
    readonly_fields = ['id', 'time_create', 'get_image']
    list_display = ['id', 'name', 'get_image', 'stock', 'available', 'price', 'time_create']
    list_display_links = ['id', 'name', 'get_image']
